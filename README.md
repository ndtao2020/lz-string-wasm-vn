...
```js
import init, { Zstd } from 'lz-string-wasm-vn/web';
...
```js
import init, { ZstdCompressor, ZstdDecompressor } from 'lz-string-wasm-vn/web';
...
const { Zstd } = require('lz-string-wasm-vn/nodejs');
...
```js
const { ZstdCompressor, ZstdDecompressor } = require('lz-string-wasm-vn/nodejs');
